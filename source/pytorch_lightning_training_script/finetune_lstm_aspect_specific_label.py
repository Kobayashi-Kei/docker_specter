...
class Specter(pl.LightningModule):
    def __init__(self, init_args):
        ...
        self.lstm_title= nn.LSTM(input_size=bertOutputSize,
                            hidden_size=bertOutputSize, batch_first=True)
        self.lstm_bg = nn.LSTM(input_size=bertOutputSize,
                            hidden_size=bertOutputSize, batch_first=True)
        self.lstm_obj = nn.LSTM(input_size=bertOutputSize,
                            hidden_size=bertOutputSize, batch_first=True)
        self.lstm_method = nn.LSTM(input_size=bertOutputSize,
                            hidden_size=bertOutputSize, batch_first=True)
        self.lstm_res = nn.LSTM(input_size=bertOutputSize,
                             hidden_size=bertOutputSize, batch_first=True)
