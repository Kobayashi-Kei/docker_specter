...
import inc.csf_rank_metrics as rm
...
def csf_eval(experiment, ranked_path, gold_path, facet):
    # graded_eval_pool_rerank(data_path=gold_path, method_name=experiment,
    #                             facet=facet, dataset='csfcube', run_path=ranked_path,
    #                             split='dev')
    aggmetrics = graded_eval_pool_rerank(data_path=gold_path, method_name=experiment,
                            facet=facet, dataset='csfcube', run_path=ranked_path,
                            split='test')
    return aggmetrics
