...
class Specter(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        loss = batch_losses / self.hparams.batch_size
...
def main():
    try:
        ...
        if args.test_only:
            ...
            wandb_logger = WandbLogger(project="SPECTER-AveragePooling-label-two-finetuning",
                                       tags=["AveragePooling", "label", 'Finetuning'])
